...
<div id="header">
	<div class="top-wrapper">
		<h1 id="logo">
			<a href="${ctxName}/index.jsp"><img
				src="../resource/images/logo.png" alt="뉴렉처" /></a>
		</h1>
		...
		<ul id="loginmenu" class="block_hlist">
			...
			<li>
				...
				href="${ctxName}/j_spring_security_logout"><security:authentication
					...
					property="authorities" var="authorities" /> <%-- <c:forEach items="${authorities}" var="auth">
							${auth.authority}
						</c:forEach> --%>
			</li>
			<li><a href="${ctxName}/joinus/join.jsp">회원가입</a></li>
		</ul>
		<h3 class="hidden">회원메뉴</h3>
		<ul id="membermenu" class="clear">
			<li><a href=""><img src="../resource/images/menu-mypage.png"
					alt="마이페이지" /></a></li>
			<li><a href="${ctxName}/notice.jsp"><img
